...
const Sidebar = ({ children, id, title, menuList }: ManagerProp) => {
    ...
    return (
        <div className="w-full min-h-dvh">
            ...
            {/* sidebar section */}
            <div className={`flex flex-col w-2/3 md:w-1/2 lg:w-1/4 h-full fixed top-0 right-full transition-transform z-50 border-r border-primary bg-white ${isShow ? `translate-x-full` : ``}`}>
