...
export const verifyAddVideo = (request: Request, response: Response, next: NextFunction) => {
...
export const verifyEditVideo = (request: Request, response: Response, next: NextFunction) => {
    /** validate a request body and grab error if exist */
